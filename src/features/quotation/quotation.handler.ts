...
import { normalizeDolibarrProposal } from "./mappers/dolibarr.ts";
import { normalizeErpNextQuotation } from "./mappers/erpnext.ts";
...
export async function callQuotationTool(
  ...
  if (name !== "erp.quotation_get") return undefined;
